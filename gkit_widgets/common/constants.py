...
BUTTON_KEY = 'BUTTON'
CANVAS_KEY = 'CANVAS'
CHECKBUTTON_KEY = 'CHECKBUTTON'
ENTRY_KEY = 'ENTRY'
FRAME_KEY = 'FRAME'
LABEL_KEY = 'LABEL'
LABELFRAME_KEY = 'LABELFRAME'
LISTBOX_KEY = 'LISTBOX'
MENU_KEY = 'MENU'
MENUBUTTON_KEY = 'MENUBUTTON'
MESSAGE_KEY = 'MESSAGE'
OPTIONMENU_KEY = 'OPTIONMENU'
PANEDWINDOW_KEY = 'PANEWINDOW'
RADIOBUTTON_KEY = 'RADIOBUTTON'
SCALE_KEY = 'SCALE'
SCROLLBAR_KEY = 'SCROLLBAR'
SPINBOX_KEY = 'SPINBOX'
TEXT_KEY = 'TEXT'
TOPLEVEL_KEY = 'TOPLEVEL'
